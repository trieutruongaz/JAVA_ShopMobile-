                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${categoryList}" var="category">
                                            ...
                                            <tr>
                                                <th scope="row">${i}</th>
                                                <td>
                                                    <img src="${pageContext.request.contextPath}/assets/images/categories/${category.image}" alt="${category.name}" onerror="this.onerror=null; this.src='${pageContext.request.contextPath}/assets/images/default-category.png';" style="width: 50px; height: 50px; object-fit: cover;" /> <!-- Displaying category image -->
                                                </td>
                                                <td>${category.name}</td>
                                                <td>

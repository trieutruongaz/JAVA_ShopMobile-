                            ...
                            <div class="bg-light rounded h-100 p-4">
                                ...
                                <form action="EditCategoryServlet" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="name" type="test" value="${category.name}" class="form-control" id="exampleInputName"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input name="thumbnail" type="thumbnail" value="${category.thumbnail}"  class="form-control" id="exampleInputThumbnail">
                                    </div>
